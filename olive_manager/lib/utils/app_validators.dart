...
class AppValidators {
  // ✅ Validation για Area (Στρέμματα)
  static String? validateArea(String? value) {
    if (value == null || value.isEmpty) {
      return '⚠️ Υποχρεωτικό πεδίο';
    }
    try {
      ...
      if (area > 10000) {
        return '⚠️ Πολύ μεγάλο εμβαδόν (>10,000 Στρέμματα)';
      }
      return null;
    } catch (e) {
  ...
  static String? validateTreeCount(String? value) {
    ...
    try {
      ...
      if (trees == 0) {
        return '⚠️ Τουλάχιστον 1 δέντρο';
      }
      if (trees > 100000) {
        return '⚠️ Πολύ μεγάλος αριθμός (>100,000)';
      }
      return null;
    } catch (e) {
  ...
  static String? validateCost(String? value) {
    ...
    try {
      ...
      if (cost > 1000000) {
        return '⚠️ Ασυνήθιστα μεγάλο κόστος';
      }
      return null;
    } catch (e) {
  ...
  // ✅ Validation για Grove Name
  static String? validateGroveName(String? value) {
    if (value == null || value.isEmpty) {
      return '⚠️ Υποχρεωτικό πεδίο';
    }
    if (value.length < 2) {
      return '⚠️ Τουλάχιστον 2 χαρακτήρες';
    }
    if (value.length > 100) {
      return '⚠️ Μέχρι 100 χαρακτήρες';
    }
    return null;
  }

  // ✅ Validation για Task Title
  static String? validateTaskTitle(String? value) {
    if (value == null || value.isEmpty) {
      return '⚠️ Υποχρεωτικό πεδίο';
    }
    if (value.length < 3) {
      return '⚠️ Τουλάχιστον 3 χαρακτήρες';
    }
    if (value.length > 150) {
      return '⚠️ Μέχρι 150 χαρακτήρες';
    }
    return null;
  }

  // ✅ Validation για Oil Volume
  static String? validateOilVolume(String? value) {
    ...
    try {
      ...
      if (volume > 100000) {
        return '⚠️ Ασυνήθιστα μεγάλη ποσότητα λαδιού';
      }
      return null;
    } catch (e) {
      return '❌ Μη έγκυρος αριθμός';
  ...
  static String? validateAcidity(String? value) {
    ...
    try {
      ...
      if (acidity > 10) {
        return '⚠️ Ασυνήθιστα υψηλή οξύτητα';
      }
      return null;
    } catch (e) {
      return '❌ Μη έγκυρος αριθμός';
